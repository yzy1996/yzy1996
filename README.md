...
😄 Hi, I'm Zhiyuan. I specialize in **Generative Models**, **3D Neural Fields**, **Multi-task Learning**, and **Multi-objective Optimization**. LLM and few-shot learning are also research areas that I am interested in. I obtained my PhD in Computer Science at [City University of Hong Kong](https://www.cityu.edu.hk/) advised by [Qingfu Zhang](https://www.cs.cityu.edu.hk/~qzhang/). Before this, I obtained my bachelor's degree in Automation at [Xi'an Jiaotong University](http://en.xjtu.edu.cn/).
